...
public:
     ...
     * @param CanChangeSelectionCallbackIn this function will be called to determine if the current Selection is allowed
     * to be modified (for example, when a Tool is active, we may wish to lock selection)
     */
