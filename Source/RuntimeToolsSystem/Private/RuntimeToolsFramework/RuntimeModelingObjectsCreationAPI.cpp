...
URuntimeModelingObjectsCreationAPI* URuntimeModelingObjectsCreationAPI::Register(UInteractiveToolsContext* ToolsContext
    ...
    if (URuntimeModelingObjectsCreationAPI* CreationAPI =
...
FCreateMeshObjectResult URuntimeModelingObjectsCreationAPI::CreateMeshObject(
...
FCreateTextureObjectResult URuntimeModelingObjectsCreationAPI::CreateTextureObject(
