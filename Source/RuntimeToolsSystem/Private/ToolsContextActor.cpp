...
void AToolsContextActor::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent) {
    ...
    // UPlayerInput::AddEngineDefinedActionMapping(FInputActionKeyMapping("StandardLeftMouseButton",
    // EKeys::LeftMouseButton)); PlayerInputComponent->BindAction("StandardMouseLeftButton", IE_Pressed, this,
    // &AToolsContextActor::OnLeftMouseDown); PlayerInputComponent->BindAction("StandardMouseLeftButton", IE_Released,
    // this, &AToolsContextActor::OnLeftMouseUp);
    ...
    UPlayerInput::AddEngineDefinedActionMapping(
        FInputActionKeyMapping("StandardMiddleMouseButton", EKeys::MiddleMouseButton)
    );
    PlayerInputComponent->BindAction(
        "StandardMiddleMouseButton", IE_Pressed, this, &AToolsContextActor::OnMiddleMouseDown
    );
    PlayerInputComponent->BindAction(
        "StandardMiddleMouseButton", IE_Released, this, &AToolsContextActor::OnMiddleMouseUp
    );

    UPlayerInput::AddEngineDefinedActionMapping(
        FInputActionKeyMapping("StandardRightMouseButton", EKeys::RightMouseButton)
    );
    PlayerInputComponent->BindAction(
        "StandardRightMouseButton", IE_Pressed, this, &AToolsContextActor::OnRightMouseDown
    );
    PlayerInputComponent->BindAction(
        "StandardRightMouseButton", IE_Released, this, &AToolsContextActor::OnRightMouseUp
    );
